...
class DragCrossingUnderBridgeTestCase(unittest.TestCase):
    ...
    def testDragCrossingUnderBridge(self):
        knot = create_knot_from_pd_code([[1,5,2,4],[3,11,4,10],[5,8,6,9],[7,12,8,1],[9,3,10,2],[11,6,12,7]], bridges = [[5,4],[8,9]])
    ...
    def testDragCrossingUnderBridge_1(self):
        knot = create_knot_from_pd_code([[2,5,3,6],[4,1,5,2],[6,3,1,4]], bridges = [[5,6],[3,4]])
    ...
    def testDragCrossingUnderBridge_2(self):
        knot = create_knot_from_pd_code([[1,9,2,8],[3,7,4,6],[5,10,6,11],[7,3,8,2],[9,1,10,12],[11,4,12,5]], bridges = [[9,8],[1,12]])
    ...
    def testDragCrossingUnderBridge_3(self):
        knot = create_knot_from_pd_code([[1,11,2,10],[3,9,4,8],[5,14,6,15],[6,11,7,12],[7,1,8,16],[9,3,10,2],[12,16,13,15],[13,4,14,5]], bridges = [[11,10],[14,15]])
    ...
    def testDragCrossingUnderBridge_4(self):
        knot = create_knot_from_pd_code([[1,4,2,5],[3,7,4,6],[5,8,6,1],[7,3,8,2]], bridges = [[4,5],[8,1]])
    ...
    def testDragCrossingUnderBridge_5(self):
        knot = create_knot_from_pd_code([[1,6,2,7],[3,11,4,10],[4,8,5,7],[5,12,6,1],[8,11,9,12],[9,3,10,2]], bridges = [[6,7],[12,1]])
        knot.drag_crossing_under_bridge(knot.crossings[5], 2)
    ...
    def testDragCrossingUnderBridge_7(self):
        knot = create_knot_from_pd_code([[7,3,8,2],[9,1,10,12],[11,4,12,5],[1,9,2,8],[3,7,4,6],[5,10,6,11]], bridges = [[3,2],[7,6]])
    ...
    def testDragCrossingUnderBridge_8(self):
        knot = create_knot_from_pd_code([[12,4,13,3],[13,1,14,18],[15,8,16,9],[16,5,17,6],[17,11,18,10],[1,4,2,5],[2,12,3,11],[6,10,7,9],[7,14,8,15]], bridges = [[4,5],[11,10]])
        knot.drag_crossing_under_bridge(knot.crossings[1], 1)
    ...
    def testDragCrossingUnderBridge_9(self):
        knot = create_knot_from_pd_code([[4,13,5,14],[6,4,7,3],[8,11,9,12],[9,1,10,14],[12,5,13,6],[1,11,2,10],[2,8,3,7]], bridges = [[1,14],[11,12]])
    ...
    def testDragCrossingUnderBridge_10(self):
        knot = create_knot_from_pd_code([[2,12,3,11],[4,10,5,9],[6,2,7,1],[8,14,9,13],[10,4,11,3],[12,6,13,5],[14,8,1,7]], bridges = [[12,11],[6,5]])
    ...
    def testDragCrossingUnderBridge_11(self):
        knot = create_knot_from_pd_code([[1,9,2,8],[3,12,4,13],[4,9,5,10],[5,15,6,14],[7,24,8,25],[10,14,11,13],[11,2,12,3],[15,18,16,19],[17,22,18,23],[19,27,20,26],[21,16,22,17],[23,1,24,28],[25,6,26,7],[27,21,28,20]], bridges = [[9,8],[12,13],[24,25]])
    ...
    def testDragCrossingUnderBridge_12(self):
        knot = create_knot_from_pd_code([[1,9,2,8],[3,12,4,13],[4,9,5,10],[5,15,6,14],[6,25,7,26],[10,14,11,13],[11,2,12,3],[15,18,16,19],[17,22,18,23],[19,29,20,28],[21,16,22,17],[23,1,24,30],[26,7,27,8],[27,25,28,24],[29,21,30,20]], bridges = [[9,8],[12,13],[25,26]])
    ...
    def testDragCrossingUnderBridge_13(self):
        knot = create_knot_from_pd_code([[2,23,3,24],[4,13,5,14],[6,22,7,21],[7,1,8,32],[8,18,9,17],[10,3,11,4],[11,26,12,27],[27,12,28,13],[14,29,15,30],[15,21,16,20],[16,32,17,31],[18,10,19,9],[19,30,20,31],[24,1,25,2],[25,22,26,23],[27,12,28,13],[28,6,29,5]], bridges = [[23,24],[1,2]])
    ...
    def testDragCrossingUnderBridge_14(self):
        knot = create_knot_from_pd_code([[15,29,16,28],[17,24,18,25],[18,4,19,3],[20,7,21,8],[22,5,23,6],[23,14,24,15],[26,2,27,1],[29,17,30,16],[30,10,1,9],[4,14,5,13],[6,21,7,22],[8,28,9,27],[10,25,11,26],[11,3,12,2],[12,19,13,20]], bridges = [[29,28],[17,16]])
    ...
    def testDragCrossingUnderBridge_15(self):
        knot = create_knot_from_pd_code([[15,35,16,34],[19,28,20,29],[20,4,21,3],[22,9,23,10],[24,7,25,8],[25,33,26,32],[26,17,27,18],[27,36,28,37],[30,2,31,1],[37,19,38,18],[38,12,1,11],[4,36,5,35],[5,17,6,16],[6,33,7,34],[8,23,9,24],[10,32,11,31],[12,29,13,30],[13,3,14,2],[14,21,15,22]], bridges = [[35,34],[17,18],[2,1]])
    ...
    def testDragCrossingUnderBridge_16(self):
        knot = create_knot_from_pd_code([[15,37,16,36],[22,2,23,1],[23,32,24,33],[24,9,25,10],[26,7,27,8],[27,35,28,34],[28,17,29,18],[29,38,30,39],[30,4,31,3],[39,19,40,18],[40,19,41,20],[41,13,42,12],[42,22,1,21],[4,38,5,37],[5,17,6,16],[6,35,7,36],[8,25,9,26],[10,34,11,33],[11,20,12,21],[13,3,14,2],[14,31,15,32]], bridges = [[37,36],[17,18],[2,1]])
...
class SimplifyRm2TestCase(unittest.TestCase):
    ...
    def testSimplifyRm2Bridges(self):
        ...
        knot = create_knot_from_pd_code([[8,19,9,20],[10,8,11,7],[11,16,12,17],[12,22,13,21],[18,9,19,10],[1,15,2,14],[2,15,3,16],[3,1,4,22],[4,14,5,13],[5,20,6,21],[6,18,7,17]], bridges = [[19,20],[18,17]])
