...
class DragCrossingUnderBridgeTestCase(unittest.TestCase):
    ...
    def testDragCrossingUnderBridge_10(self):
        knot = create_knot_from_pd_code([[2,12,3,11],[4,10,5,9],[6,2,7,1],[8,14,9,13],[10,4,11,3],[12,6,13,5],[14,8,1,7]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[5])
    ...
    def testDragCrossingUnderBridge_11(self):
        knot = create_knot_from_pd_code([[1,9,2,8],[3,12,4,13],[4,9,5,10],[5,15,6,14],[7,24,8,25],[10,14,11,13],[11,2,12,3],[15,18,16,19],[17,22,18,23],[19,27,20,26],[21,16,22,17],[23,1,24,28],[25,6,26,7],[27,21,28,20]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[1])
        knot.designate_bridge(knot.crossings[4])
    ...
    def testDragCrossingUnderBridge_12(self):
        knot = create_knot_from_pd_code([[1,9,2,8],[3,12,4,13],[4,9,5,10],[5,15,6,14],[6,25,7,26],[10,14,11,13],[11,2,12,3],[15,18,16,19],[17,22,18,23],[19,29,20,28],[21,16,22,17],[23,1,24,30],[26,7,27,8],[27,25,28,24],[29,21,30,20]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[1])
        knot.designate_bridge(knot.crossings[4])
    ...
    def testDragCrossingUnderBridge_13(self):
        knot = create_knot_from_pd_code([[2,23,3,24],[4,13,5,14],[6,22,7,21],[7,1,8,32],[8,18,9,17],[10,3,11,4],[11,26,12,27],[27,12,28,13],[14,29,15,30],[15,21,16,20],[16,32,17,31],[18,10,19,9],[19,30,20,31],[24,1,25,2],[25,22,26,23],[27,12,28,13],[28,6,29,5]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[13])
    ...
    def testDragCrossingUnderBridge_14(self):
        knot = create_knot_from_pd_code([[15,29,16,28],[17,24,18,25],[18,4,19,3],[20,7,21,8],[22,5,23,6],[23,14,24,15],[26,2,27,1],[29,17,30,16],[30,10,1,9],[4,14,5,13],[6,21,7,22],[8,28,9,27],[10,25,11,26],[11,3,12,2],[12,19,13,20]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[7])
    ...
    def testDragCrossingUnderBridge_16(self):
        knot = create_knot_from_pd_code([[15,37,16,36],[22,2,23,1],[23,32,24,33],[24,9,25,10],[26,7,27,8],[27,35,28,34],[28,17,29,18],[29,38,30,39],[30,4,31,3],[39,19,40,18],[40,19,41,20],[41,13,42,12],[42,22,1,21],[4,38,5,37],[5,17,6,16],[6,35,7,36],[8,25,9,26],[10,34,11,33],[11,20,12,21],[13,3,14,2],[14,31,15,32]])
        knot.designate_bridge(knot.crossings[0])
        knot.designate_bridge(knot.crossings[6])
        knot.designate_bridge(knot.crossings[1])
